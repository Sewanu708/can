      ...
      components: [
        ...
        },
        {
          ...
          components: [
            ...
            {
              type: "link",
              attributes: { href: "https://facebook.com", target: "_blank" },
              style: {
                display: "inline-flex",
                color: "#1877f2",
                "text-decoration": "none",
              ...
              components: [
                {
                  ...
                  content: `<path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>`,
                },
              ],
            },
            // Twitter/X
            {
              type: "link",
              attributes: { href: "https://twitter.com", target: "_blank" },
              style: {
                display: "inline-flex",
                color: "#1da1f2",
                "text-decoration": "none",
              ...
              components: [
                {
                  ...
                  content: `<path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>`,
                },
              ],
            },
            // Instagram
            {
              type: "link",
              attributes: { href: "https://instagram.com", target: "_blank" },
              style: {
                display: "inline-flex",
                color: "#e1306c",
                "text-decoration": "none",
            ...
            {
              type: "link",
              attributes: { href: "https://linkedin.com", target: "_blank" },
              style: {
                display: "inline-flex",
                color: "#0a66c2",
                "text-decoration": "none",
              ...
              components: [
                {
                  ...
                  content: `<path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle>`,
                },
              ],
            },
          ],
