              ...
              {message.role === "assistant" ? (
                <ReactMarkdown
                  components={{
                    ...
                    pre: ({ children }) => (
                      <pre className="bg-gray-900 text-gray-100 p-3 rounded-lg overflow-x-auto mb-2 mt-2">
                        {children}
                      </pre>
                    ),
                  }}
      ...
      >
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full p-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none overflow-hidden"
            rows={2}
            value={input}
            onChange={handleInputChangeWrapper}
